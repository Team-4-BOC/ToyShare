...
const RenteeInfo = ({ renteeData }) => {
  return (
    ...
    <div className="card-body">
      ...
      <p data-testid='rentee_description' style={{ fontSize: 15, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>Proud parent of amazing kids. Check out my inventory of toys for rental!</p>
    </div>
  </div>
  );
};
