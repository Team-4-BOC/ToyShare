...
const PhotoCarousel = ({ toy, handleSave, setPage }) => {
  return (
    <div className='relative'>
      <div className='btn rounded-md btn-sm text-xs btn-square bg-gray-900 text-white top-2 left-4 absolute z-1' onClick={() => setPage(0)}>❮</div>
      <button className="btn rounded-md btn-sm btn-square bg-gray-900 top-2 right-4 absolute z-1" onClick={handleSave}>
