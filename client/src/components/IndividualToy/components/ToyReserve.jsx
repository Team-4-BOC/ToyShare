  ...
  return (
    <div className='bottom-0 fixed'>
      <div className='flex w-full px-4 py-5 bg-gray-950 bottom-0 fixed border-2 border-b-stone-600'>
       ...
       {toy.next_date ? <div data-testid='it-reserveButton' className='rounded-xl btn btn-primary ml-auto bg-red-600 text-white' onClick={handlereserveClick}>Reserve</div> : null}
      </div>
